...
?>
	...
	<link href="<?php echo $this->baseurl; ?>/includes/js/calendar/calendar-mos.css" rel="stylesheet" type="text/css" />
	<style type="text/css">
	...
	<?php endif; ?>
<script type="text/javascript">var cbTemplateDir="<?php echo $this->baseurl;?>/templates/<?php echo $this->template?>/images/"</script>
<script type="text/javascript">Calendar = function () { };</script>
<script language="javascript" type="text/javascript" src="<?php echo $this->baseurl;?>/includes/js/calendar/calendardateinput.js" ></script>
<script language="javascript" type="text/javascript" src="<?php echo $this->baseurl;?>/includes/js/calendar/calendar_mini.js" ></script>
<script language="javascript" type="text/javascript" src="<?php echo $this->baseurl;?>/includes/js/calendar/lang/calendar-en-GB.js" ></script>
	...
	<div id="mainwrapper">
		...
		<div class="wrapper">
					...
					<a href="<?php echo $this->baseurl; ?>" class="nounder"><span id="logo"></span><!--img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template?>/images/blank.gif" style="border:0;" alt="" id="logo" /--></a>
		...
		<div>
		<a href="http://www.danafarber.org/" target="_blank"><img src="images/stories/logos/DFCI_gray.gif" border="0" align="top" alt="Dana-Farber Cancer Institute" style="margin-left:20px; margin-right:20px" /></a><a href="http://www.mskcc.org" target="_blank"><img src="images/stories/logos/MSKCC.gif" border="0"  align="top" alt="Memorial Sloan-Kettering Cancer Center" style="margin-left:20px; margin-right:20px" /></a><a 
		href="http://www.ohsu.edu" target="_blank"><img src="images/stories/logos/oregon_health_science.gif" border="0"  align="top" alt="Oregon Health and Science University" style="margin-left:20px; margin-right:20px" /></a><a href="http://www.mdanderson.org" target="_blank"><img src="images/stories/logos/MDAnderson.gif" border="0"  align="top"  alt="The University of Texas,
M. D. Anderson Cancer Center" style="margin-left:20px; margin-right:20px" /></a><a href="http://www.gistsupport.org" target="_blank"><img src="images/stories/logos/GSI-logo.gif" border="0"  align="top"  alt="GIST Support International" style="margin-left:20px; margin-right:20px" /></a><a href="http://www.liferaftgroup.org" target="_blank"><img src="images/stories/logos/lrg200.gif" border="0" align="top"  alt="Life Raft Group" /></a>
		</div>
